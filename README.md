...
## Vollständige Variantenkataloge und gestufter Randomizer (1.30-test)

Jeder der drei zusätzlichen Modi enthält jetzt 90 feste Rätsel, jeweils 30 pro Stufe. Innerhalb der Stufe steigt die berechnete Komplexität; die sichtbare Nummerierung beginnt pro Stufe bei 01. Der Abschluss führt direkt zum nächsten Katalogrätsel. Alle 18 veröffentlichten Originalrätsel behalten IDs, Netze und Drehkopplungen sowie vorhandene Spielstände. Ein bereits veröffentlichtes Paar im Zwei-Stromkreise-Katalog hat dieselbe Topologie; dieses bleibt bewusst erhalten. Alle neu hinzugefügten Topologien sind untereinander und gegenüber dem Bestand dedupliziert.

Die modusspezifische Bewertung nutzt Rand-/Nachbarbedingungen, synchrone Ableitungswellen, verbleibende Möglichkeiten und räumliche Kopplungen. Lichtweg modelliert nicht benötigte Kacheln als optionale dunkle Zustände und entfernt nicht erreichbare Restmöglichkeiten. Gekoppelte Steine sind eine gemeinsame Variable. Die Bewertung verwendet weder die Zielstellung noch die zufälligen Ausgangsdrehungen als Abkürzung. Unterschiedliche Rastergrößen können deshalb dieselbe Stufe haben. Das ist eine nachvollziehbare Schwierigkeitsschätzung, keine Garantie für die subjektive Spielerfahrung oder einen eindeutigen Lösungsweg; alternative gültige Lösungen bleiben ausdrücklich erlaubt. Die Schwellen sind je Regelwerk anhand von Kandidatenpools kalibriert.

Neue Generatorversion mit 3×3 bis 6×6: Zwei Stromkreise bekommt vielfältigere zusammenhängende Farbbereiche, Lichtweg variiert die Zahl der unbenutzten Kacheln und gekoppelte Drehungen enthalten auch weiter auseinanderliegende Zahlenpaare. Die ursprüngliche Generatorversion bleibt für gespeicherte alte Zufallsrätsel verfügbar. Auswahl von Leicht/Mittel/Schwer und automatischer oder konkreter Rastergröße; nur zuverlässig verfügbare Kombinationen werden angeboten. Die Erzeugung läuft in einem abbrechbaren Worker, ist zeitlich begrenzt und liefert ausschließlich die angeforderte Schwierigkeit. Die letzten 36 Zufallstopologien und alle Katalogtopologien werden ausgeschlossen. Neue freie Spielstände und die Wiederholungssperre werden in vorhandene Sicherungen integriert.

Geprüft: alle bestehenden Tests und TypeScript; 270 Katalogrätsel samt Hilfe/Undo, 18 unveränderte Originale, drehungsunabhängige Bewertung, monotone Kategorien, 312 Zufallsrätsel über alle 39 angebotenen Kombinationen einschließlich Auto, keine aktuellen/Katalogduplikate, Zeit-/Versuchslimits und Sicherungswiederherstellung für beide Generatorversionen. Browser: schweres 6×6-Zufallsrätsel erzeugt, Drehung gespeichert und fortgesetzt, komplett testgelöst; Kategorien geöffnet, Rätsel 01 und direkter Wechsel zu 02. 393×780 zeigt das 6×6-Brett samt Testbuttons ohne Scrollbedarf. Android-APK gebaut; weitere physische Geräte- und Schwierigkeitstests durch Nutzer stehen aus.


## Freie Tageswahl, geprüfte optimale Züge und Komplexität (1.31-test)

Ab 21.09.2026 gibt es drei Tagesplätze (leicht/mittel/schwer), jeweils frei mit einem der sechs Modi belegbar. Dreimal derselbe Modus ist erlaubt. Regulärer Abschluss bindet den Platz; Tages-XP werden je Datum/Platz einmal vergeben. Alte v1-Tagesrätsel und bereits erreichte Tagesabschlüsse bleiben gültig. Der Kalender und der Trio-Erfolg zählen Plätze, die Streak weiterhin den tatsächlichen Spieltag. Die Modus-Tagesmission lässt alternativ drei verschiedene Rätsel zu. Angefangene Bretter bleiben pro Datum, Platz und Modus gespeichert und werden in Sicherungen berücksichtigt.

223 Erfolgsstufen: zusätzlich 200 verschiedene Rätsel ohne Hilfe, eine Reihe für hilfefreie Partien inklusive Wiederholungen und sechs Reihen für optimale Lösungen (1/10/50/100/200/500/1000 verschiedene Rätsel pro Modus). Alle Stufen vergeben XP. Optimale Abschlüsse verlangen reguläres Spiel von Anfang an, keine Hilfe und keine zusätzlichen, später rückgängig gemachten Züge. Bestehende Abschlüsse ohne vollständiges Zugprotokoll werden nicht nachträglich als optimal behauptet.

Für sämtliche 680 Katalogrätsel ist die tatsächliche Mindestzugzahl vorausberechnet (`curate-optimal.mjs`); Signaturen binden die Ergebnisse an das konkrete Startbrett und die Regeln. Der exakte Prüfer berücksichtigt alternative fertige Netze, dunkle Lichtweg-Kacheln und gemeinsame Drehungen. Für Schieben & Drehen untersucht er erreichbare Anordnungen mit kürzester Schiebedistanz und löst die Orientierungen separat: Drehungen und Schiebungen kommutieren. Zufalls-/Tagesrätsel werden nach hilfefreiem Abschluss im Worker geprüft. Ein Zeit-/Arbeitslimit liefert unbekannt, niemals einen unbelegten Optimal-Erfolg.

Die drei Varianten haben jetzt 410 Katalogrätsel (140 zusätzliche), insgesamt 680 mit den bisherigen Modi. Keine veröffentlichte ID oder Startstellung wurde ersetzt. Die neue Einstufung prüft lokale Folgerungswellen und plausible Entscheidungen nach unmittelbaren Nachbarprüfungen; bestätigte Widersprüche, ihre Tiefe und lange Ketten bestimmen den Wert. Bloße Rastergröße, Kopplungsdistanz und uneindeutige Optionen sind kein Schwierigkeitsbeweis. Viele bisher überbewertete Bretter werden dadurch leichter eingestuft. Der versionierte v3-Generator erzeugt stärker verzweigte Netze und weniger überbestimmte Kopplungen; v1/v2-Spielstände bleiben reproduzierbar. Mindestens 30 Rätsel pro Modus/Stufe; Zahlen in der Oberfläche stammen aus den tatsächlichen Katalogen. Schwierigkeit bleibt eine begründete Schätzung, die menschliche Tests verfeinern müssen.

Prüfung: unabhängige exhaustive Optimal-Orakel für kleine Varianten, legale BFS-Vergleiche für beide Schieberegeln, alle Katalogsignaturen, alle 18 Tageskombinationen samt Sicherungs-Roundtrip, gleichartige Tagestrios, XP-Deduplizierung und Streak-Nachholen, Undo-/Hilfenausschlüsse und bestehende Regressionstests. Browser: reguläres Lichtweg-Tagesrätsel in zehn optimalen Zügen gelöst; Zertifikat und Erfolgs-XP sichtbar, Tagesplatz anschließend gebunden. Schweres gekoppeltes Tagesrätsel in 6×6 erzeugt, bei 393×780 samt Testbuttons vollständig sichtbar. Android-Test-APK gebaut; weitere Tests auf echten Geräten durch Nutzer stehen aus.
